...
extension Aiuta.Configuration.Features.WelcomeScreen {
    ...
    public struct Typography: Sendable {
        ...
        public let welcomeTitle: Aiuta.TextStyle
        
        /// Text style for the welcome screen description.
        public let welcomeDescription: Aiuta.TextStyle
        ...
        public init(welcomeTitle: Aiuta.TextStyle,
                    welcomeDescription: Aiuta.TextStyle) {
            self.welcomeTitle = welcomeTitle
            self.welcomeDescription = welcomeDescription
        }
    }
