...
/// class fires.
@_spi(Aiuta) public final class Signal<T> {
...
@_spi(Aiuta) public extension Signal where T == Void {
    func fire() {
        fire(())
    }
}
...
@_spi(Aiuta) public final class SignalSubscription<T> {
    public typealias SignalCallback = (T) -> Void
