...
@_spi(Aiuta) public extension UIBezierPath {
    ...
    convenience init(continuousRoundedRect rect: CGRect, cornerRadius: CGFloat) {
        self.init(cgPath: UIBezierPath.continuousRoundedRect(rect, cornerRadius: cornerRadius).cgPath)
    }

    private static func continuousRoundedRect(_ rect: CGRect, cornerRadius: CGFloat) -> UIBezierPath {
        return continuousRoundedRect(rect, cornerRadius: (cornerRadius, cornerRadius, cornerRadius, cornerRadius))
    }

    private static func continuousRoundedRect(_ rect: CGRect, cornerRadius: (topLeft: CGFloat, topRight: CGFloat, bottomLeft: CGFloat, bottomRight: CGFloat)) -> UIBezierPath {
