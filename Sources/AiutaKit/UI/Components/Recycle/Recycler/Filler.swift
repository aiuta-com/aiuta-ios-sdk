//
//  Created by nGrey on 19.06.2023.
//

import UIKit

open class Filler<FillViewType, FillDataType>: Content<PlainView> where FillViewType: Recycle<FillDataType>, FillDataType: AnyObject {
