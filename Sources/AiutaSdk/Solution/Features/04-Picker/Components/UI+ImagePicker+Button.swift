    ...
    final class PhotoInputButton: PlainButton {
        ...
        override func updateLayout() {
            ...
            divider.layout.make { make in
                make.left = ds.styles.extendDelimitersToTheLeft ? 0 : title.layout.left
                make.right = ds.styles.extendDelimitersToTheRight ? 0 : title.layout.right
                make.height = 1
                make.bottom = 0
            }
        }
